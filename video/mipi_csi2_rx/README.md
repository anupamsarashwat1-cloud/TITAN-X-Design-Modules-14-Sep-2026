...
graph LR
    ...
    Output[Stream Output]:::sub --> mipi_csi2_rx
```
...
graph LR
    ...
    axis_tdata_reg["axis_tdata_reg\n(reg, 32)"]:::sig
    axis_tvalid_reg["axis_tvalid_reg\n(reg, 1)"]:::sig
    axis_tlast_reg["axis_tlast_reg\n(reg, 1)"]:::sig
    axis_tuser_reg["axis_tuser_reg\n(reg, 1)"]:::sig
```
