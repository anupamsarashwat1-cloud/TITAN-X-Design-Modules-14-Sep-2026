...
graph LR
    ...
    Processor[Signal Processor]:::sub --> isp_pipeline
    Registers[Config Registers]:::sub --> isp_pipeline
```
...
graph LR
    ...
    pipe_tdata["pipe_tdata\n(reg, 32)"]:::sig
    pipe_tvalid["pipe_tvalid\n(reg, 1)"]:::sig
    pipe_tuser["pipe_tuser\n(reg, 1)"]:::sig
    pipe_tlast["pipe_tlast\n(reg, 1)"]:::sig
```
