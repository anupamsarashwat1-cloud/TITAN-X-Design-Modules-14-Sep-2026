...
graph LR
    ...
    wire["wire\n(output, 1)"]:::port
    wire["wire\n(output, 1)"]:::port
    mm2s_vsize["mm2s_vsize\n(reg, 32)"]:::sig
    mm2s_hsize["mm2s_hsize\n(reg, 32)"]:::sig
    mm2s_stride["mm2s_stride\n(reg, 32)"]:::sig
    s2mm_vsize["s2mm_vsize\n(reg, 32)"]:::sig
    s2mm_hsize["s2mm_hsize\n(reg, 32)"]:::sig
    s2mm_stride["s2mm_stride\n(reg, 32)"]:::sig
    cr["cr\n(reg, 32)"]:::sig
    sr["sr\n(reg, 32)"]:::sig
```
